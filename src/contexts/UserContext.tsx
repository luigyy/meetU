...
//make api call to fill fields
export const dataFromApi: UserInterface = {
  name: "Luigy",
...
export const UserContextProvider = ({ children }) => {
  ...
  const [age, setAge] = useState(dataFromApi.age);
  const [slogan, setSlogan] = useState(dataFromApi.slogan);
