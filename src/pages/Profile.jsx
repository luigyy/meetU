        ...
        <div className="w-full md:w-1/2 h-screen  ">
          ...
          <div className="pr-10 py-10 ">
            ...
            <div className=" grid grid-cols-1 min-[470px]:grid-cols-2 min-[1200px]:grid-cols-3 gap-4 p-5">
              <span className="bg-gray-300 px-7 py-1 rounded-3xl flex justify-between items-center opacity-80 w-full shadow-xl ">
                <span>Buscando:</span>
                {/* 💕|| 🤝 */}
              ...
              <span className="bg-gray-300 px-7 py-1 rounded-3xl flex justify-between items-center opacity-80 w-full  ">
                <span>🏖️ ó ⛰️:</span>
                <span className="pl-5 text-2xl">🏖️</span>
              </span>
            </div>
            <span></span>
          </div>
        ...
        <div className="w-full min-h-screen bg-gray-300">
          <div className="p-20">
            ...
            <p className="leading-7 text-center">
              ...
              nam perferendis harum cupiditate aut omnis, natus praesentium. Id,
              eum eius. Distinctio?
            </p>
          </div>
