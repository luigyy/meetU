  ...
  return (
    <div>
      <div className="md:mr-[7%]">
        ...
        {/* third card, ask me something text area and social media*/}
        <div className="h-screen  m-5 mb-20 border-4 border-orange-500 mx-auto">
          {" "}
        </div>
      </div>
      {/* blur div  */}
      <div className="fixed md:h-[100%] md:w-[7%] md:right-0 md:top-0 h-[10%] sm:blur-bg sm:opacity-80 bottom-0 w-full bg-gray-200 "></div>
      {/* blur div  */}
      <div className="fixed md:h-[100%] md:w-[7%] md:right-0 md:top-0 h-[10%] bottom-0 w-full md:bg-gray-200 items-center ">
