    ...
    <div>
      <div>
            ...
            <div className="w-full md:w-1/2 h-screen  ">
              ...
              <div className="pr-10 py-10 ">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-5">
                  ...
                  <DropdownComponent title="Fiesta: " options={["👎", "👍"]} />
                  <DropdownComponent title="🐕 or 🐈" options={["🐕", "🐈"]} />
                  <DropdownComponent title="🏖️ or ⛰️" options={["🏖️", "⛰️"]} />
                </div>
                <span></span>
              </div>
            </div>
        ...
        <div className="fixed md:h-screen  md:w-[6%] md:bg-gray-200 md:top-0 md:right-0 bottom-0 h-[12vh] p-2 w-full">
          <Interaction forEditProfile={true} />
        </div>{" "}
      </div>
    </div>
  );
